...
| #16 | ~~P1~~ | ~~Double-injection divergence~~ | — | **RESOLVED 2026-06-13 — Option A (commits f80c65b/bff1122/11f0cf8).** `corpus/validate.py` written with cascade-aware expected-surface map; injector guards added. One step open: `make validate` end-to-end run requires live Postgres (logic is unit-tested). See `docs/finding-16-ledger-mart-divergence.md`. |
